...
from ..exceptions.syntax import ServiceNotFoundException
...
class Request(object):
    ...
    def parse(self, server):
        ...
        try:
            service_module = __import__("featureserver.services.%s" % service_name.lower(), globals(), locals(), service_name)
