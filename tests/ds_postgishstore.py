...
class PostGISHstoreTestCase(unittest.TestCase, datasource.Base):
    ...
    def data_features_ordered(self):
        return """<?xml version="1.0" ?><wfs:FeatureCollection xmlns:fs="http://featureserver.org/fs" xmlns:wfs="http://www.opengis.net/wfs" xmlns:gml="http://www.opengis.net/gml" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.opengis.net/wfs http://schemas.opengeospatial.net//wfs/1.0.0/WFS-basic.xsd"> <gml:featureMember gml:id="4"><fs:fs_point_hstore fid="4"><gml:Point srsName="EPSG:4326"><gml:coordinates decimal="." cs="," ts=" ">7.877841,46.384567</gml:coordinates></gml:Point><fs:salary>112000</fs:salary><fs:name>Sykes</fs:name><fs:street>5th avenue</fs:street><fs:kvp>"name"=&gt;"Sykes", "salary"=&gt;"112000", "street"=&gt;"5th avenue"</fs:kvp></fs:fs_point_hstore></gml:featureMember><gml:featureMember gml:id="5"><fs:fs_point_hstore fid="5"><gml:Point srsName="EPSG:4326"><gml:coordinates decimal="." cs="," ts=" ">8.811679,46.788513</gml:coordinates></gml:Point><fs:salary>None</fs:salary><fs:name>Steger</fs:name><fs:street>main street 20</fs:street><fs:kvp>"name"=&gt;"Steger", "street"=&gt;"main street 20", "salary="=&gt;"130000"</fs:kvp></fs:fs_point_hstore></gml:featureMember><gml:featureMember gml:id="3"><fs:fs_point_hstore fid="3"><gml:Point srsName="EPSG:4326"><gml:coordinates decimal="." cs="," ts=" ">7.383456,46.983736</gml:coordinates></gml:Point><fs:salary>125000</fs:salary><fs:name>Mcmillon</fs:name><fs:street>None</fs:street><fs:kvp>"name"=&gt;"Mcmillon", "salary"=&gt;"125000"</fs:kvp></fs:fs_point_hstore></gml:featureMember><gml:featureMember gml:id="2"><fs:fs_point_hstore fid="2"><gml:Point srsName="EPSG:4326"><gml:coordinates decimal="." cs="," ts=" ">7.58121,47.379493</gml:coordinates></gml:Point><fs:salary>129000</fs:salary><fs:name>Fewell</fs:name><fs:street>None</fs:street><fs:kvp>"name"=&gt;"Fewell", "salary"=&gt;"129000"</fs:kvp></fs:fs_point_hstore></gml:featureMember><gml:featureMember gml:id="6"><fs:fs_point_hstore fid="6"><gml:Point srsName="EPSG:4326"><gml:coordinates decimal="." cs="," ts=" ">8.157992,47.081082</gml:coordinates></gml:Point><fs:salary>None</fs:salary><fs:name>Conroy</fs:name><fs:street>None</fs:street><fs:kvp>"name"=&gt;"Conroy", "salary="=&gt;"120000"</fs:kvp></fs:fs_point_hstore></gml:featureMember><gml:featureMember gml:id="1"><fs:fs_point_hstore fid="1"><gml:Point srsName="EPSG:4326"><gml:coordinates decimal="." cs="," ts=" ">8.515048,47.461261</gml:coordinates></gml:Point><fs:salary>109000</fs:salary><fs:name>Carrasquillo</fs:name><fs:street>main street 1986</fs:street><fs:kvp>"name"=&gt;"Carrasquillo", "salary"=&gt;"109000", "street"=&gt;"main street 1986"</fs:kvp></fs:fs_point_hstore></gml:featureMember></wfs:FeatureCollection>"""
    
    @property
    def data_features_queryable(self):
        return """<?xml version="1.0" ?><wfs:FeatureCollection xmlns:fs="http://featureserver.org/fs" xmlns:wfs="http://www.opengis.net/wfs" xmlns:gml="http://www.opengis.net/gml" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.opengis.net/wfs http://schemas.opengeospatial.net//wfs/1.0.0/WFS-basic.xsd"> <gml:featureMember gml:id="2"><fs:fs_point_hstore fid="2"><gml:Point srsName="EPSG:4326"><gml:coordinates decimal="." cs="," ts=" ">7.58121,47.379493</gml:coordinates></gml:Point><fs:salary>129000</fs:salary><fs:name>Fewell</fs:name><fs:street>None</fs:street><fs:kvp>"name"=&gt;"Fewell", "salary"=&gt;"129000"</fs:kvp></fs:fs_point_hstore></gml:featureMember><gml:featureMember gml:id="3"><fs:fs_point_hstore fid="3"><gml:Point srsName="EPSG:4326"><gml:coordinates decimal="." cs="," ts=" ">7.383456,46.983736</gml:coordinates></gml:Point><fs:salary>125000</fs:salary><fs:name>Mcmillon</fs:name><fs:street>None</fs:street><fs:kvp>"name"=&gt;"Mcmillon", "salary"=&gt;"125000"</fs:kvp></fs:fs_point_hstore></gml:featureMember></wfs:FeatureCollection>"""
    ...
    @property
    def data_delete_single_tuple_response(self):
...
class PostGISHstoreWFS200TestCase(PostGISHstoreTestCase):
    def test_keyword_features(self):
        response = self.fs.dispatchRequest(Request(base_path = "", path_info = "/wfs/fs_point_hstore/features.wfs", params = {'version':'2.0.0'}))
        self.assertEqual(re.sub(' +', ' ', response.data.replace("\n", "").replace("\t", "")), self.data_features)
    
    def test_keyword_by_id(self):
        response = self.fs.dispatchRequest(Request(base_path = "", path_info = "/wfs/fs_point_hstore/2.wfs", params = {'version':'2.0.0'}))
        self.assertEqual(re.sub(' +', ' ', response.data.replace("\n", "").replace("\t", "")), self.data_feature_two)
    
    def test_get_features(self):
        response = self.fs.dispatchRequest(Request(base_path = "", path_info = "/wfs", params = {'version':'2.0.0', 'request':'GetFeature', 'typenames':'fs_point_hstore'}))
        self.assertEqual(re.sub(' +', ' ', response.data.replace("\n", "").replace("\t", "")), self.data_features)
    
    def test_get_bbox(self):
        response = self.fs.dispatchRequest(Request(base_path = "", path_info = "", params = {'service':'WFS','version':'2.0.0', 'request':'GetFeature', 'typenames':'fs_point_hstore', 'bbox':'7.0,46.0,8.0,47.0'}))
        self.assertEqual(re.sub(' +', ' ', response.data.replace("\n", "").replace("\t", "")), self.data_features_bbox)
    
    def test_post_features(self):
        response = self.fs.dispatchRequest(Request(base_path = "", path_info = "", params = {}, request_method = "POST", post_data = '<wfs:GetFeature xmlns:wfs="http://www.opengis.net/wfs" service="WFS" version="2.0.0" xsi:schemaLocation="http://www.opengis.net/wfs http://schemas.opengis.net/wfs/1.1.0/wfs.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><wfs:Query typeNames="fs_point_hstore" srsName="EPSG:4326" /></wfs:GetFeature>'))
        self.assertEqual(re.sub(' +', ' ', response.data.replace("\n", "").replace("\t", "")), self.data_features)

    @unittest.skip("Not supported in WFS 2.x")
    def test_post_by_gml_id(self):
        response = self.fs.dispatchRequest(Request(base_path = "", path_info = "", params = {}, request_method = "POST", post_data = '<wfs:GetFeature xmlns:wfs="http://www.opengis.net/wfs" service="WFS" version="2.0.0" xsi:schemaLocation="http://www.opengis.net/wfs http://schemas.opengis.net/wfs/1.1.0/wfs.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><wfs:Query typeName="fs_point_hstore" srsName="EPSG:4326" /><ogc:Filter xmlns:ogc="http://www.opengis.net/ogc"><ogc:GmlObjectId xmlns:gml="http://www.opengis.net/gml" gml:id="2"/></ogc:Filter></wfs:GetFeature>'))
        self.assertEqual(re.sub(' +', ' ', response.data.replace("\n", "").replace("\t", "")), self.data_feature_two)
    
    def test_post_by_feat_id(self):
        response = self.fs.dispatchRequest(Request(base_path = "", path_info = "", params = {}, request_method = "POST", post_data = '<wfs:GetFeature xmlns:wfs="http://www.opengis.net/wfs" service="WFS" version="2.0.0" xsi:schemaLocation="http://www.opengis.net/wfs http://schemas.opengis.net/wfs/1.1.0/wfs.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><wfs:Query typeNames="fs_point_hstore" srsName="EPSG:4326" /><ogc:Filter xmlns:ogc="http://www.opengis.net/ogc"><ogc:ResourceId rid="2"/></ogc:Filter></wfs:GetFeature>'))
        self.assertEqual(re.sub(' +', ' ', response.data.replace("\n", "").replace("\t", "")), self.data_feature_two)

    def test_post_insert_single(self):
        request = Request(base_path = "", path_info = "", params = {}, request_method = "PUT", post_data = '<wfs:Transaction xmlns:wfs="http://www.opengis.net/wfs" service="WFS" version="2.0.0" xsi:schemaLocation="http://www.opengis.net/wfs http://schemas.opengis.net/wfs/1.1.0/wfs.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><wfs:Insert><fs_point_hstore xmlns:feature="http://example.com/featureserver"><geom><gml:Point xmlns:gml="http://www.opengis.net/gml" srsName="EPSG:4326"><gml:pos>8.65237703580643 47.2491447055323</gml:pos></gml:Point></geom></fs_point_hstore></wfs:Insert></wfs:Transaction>')
        transactions = self.ds_process('fs_point_hstore', request)
        ...
        # test if feature was inserted into database by querying by its id
        response = self.fs.dispatchRequest(Request(base_path = "", path_info = "/wfs/fs_point_hstore/7.wfs", params = {'version':'2.0.0'}))
        self.assertEqual(re.sub(' +', ' ', response.data.replace("\n", "").replace("\t", "")), self.data_insert_single_feature)

    def test_post_update_single(self):
        # update feature 1
        request = Request(base_path = "", path_info = "", params = {}, request_method = "PUT", post_data = '<wfs:Transaction xmlns:wfs="http://www.opengis.net/wfs" service="WFS" version="2.0.0" xsi:schemaLocation="http://www.opengis.net/wfs http://schemas.opengis.net/wfs/1.1.0/wfs.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml"><wfs:Update typeName="fs_point_hstore"><wfs:Property><wfs:ValueReference>kvp</wfs:ValueReference><wfs:Value>kvp || ("name" =&gt; "Alfredo")</wfs:Value></wfs:Property><wfs:Property><wfs:ValueReference>kvp</wfs:ValueReference><wfs:Value>kvp || ("salary" =&gt; "90900")</wfs:Value></wfs:Property><ogc:Filter><ogc:ResourceId rid="1"/></ogc:Filter></wfs:Update></wfs:Transaction>')
        transactions = self.ds_process('fs_point_hstore', request)
    ...
    def test_post_delete_multiple_tuples(self):
        response = self.fs.dispatchRequest(Request(base_path = "", path_info = "", params = {}, request_method = "PUT", post_data = '<wfs:Transaction xmlns:wfs="http://www.opengis.net/wfs" service="WFS" version="2.0.0" xsi:schemaLocation="http://www.opengis.net/wfs http://schemas.opengis.net/wfs/1.1.0/wfs.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml"><wfs:Delete typeName="fs_point_hstore"><ogc:Filter><ogc:ResourceId rid="1"/><ogc:ResourceId rid="3"/></ogc:Filter></wfs:Delete></wfs:Transaction>'))
        self.assertEqual(re.sub(' +', ' ', response.data.replace("\n", "").replace("\t", "")), self.data_delete_multiple_response)
