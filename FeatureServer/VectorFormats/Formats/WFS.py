from FeatureServer.VectorFormats.Formats.Format import Format
...
class WFS(Format):
   ...
   xsi:schemaLocation="http://www.opengis.net/wfs http://schemas.opengeospatial.net//wfs/1.0.0/WFS-basic.xsd">
    ...
    def get_capabilities(self):
        tree = etree.parse(os.path.dirname(os.path.abspath(__file__))+"/../../assets/transformation/wfs-capabilities.xml")
        root = tree.getroot()
    ...
    def describe_feature_type(self):
        tree = etree.parse(os.path.dirname(os.path.abspath(__file__))+"/../../assets/transformation/wfs-featuretype.xsd")
        root = tree.getroot()
